!(function(t, i) {
    ...
    var o = function(i) {
        var e,
            o = {};
        return (!!window.elementor.hasOwnProperty("elements") &&
            ...
            (t.each(e.models, function(e, n) {
                ...
                speed: o.wpkoi_tricks_widget_parallax_speed || {
                    size: 50,
                    unit: "%"
                },
    ...
    (window.wpkoiWidgetParallax = function(e) {
        ...
        (n.init = function() {
            return (
                e.addClass(w), !!(r = d ? o(s) : e.data("wpkoi-tricks-settings")) &&
                void 0 !== r &&
                "false" !== r.parallax &&
                void 0 !== r.parallax &&
        ...
        (n.scrollHandler = function(t) {
            ...
            (c = o * Math.ceil(i * c)), -1 !== _.indexOf(k) ? a.css({
    ...
    (window.wpkoiWidgetSatellite = function(e) {
        ...
        this.init = function() {
            return (!!(a = l ? o(n) : e.data("wpkoi-tricks-settings")) &&
                void 0 !== a &&
                "false" !== a.satellite &&
                void 0 !== a.satellite &&
